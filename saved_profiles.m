...
profile_name = "Human, R/H - 8.192s Windows (All Patients)";
p = struct;
% p.primary_var = "frequency_limit";
p.primary_var = "alpha";
p.primary_vals = 0.5;
...
%     'normalize_power', true);
p.line_configs = {
    % struct('signal_sel', "raw_signal", 'window_duration', 8.192)
    % struct('signal_sel', "IPFM_signal", 'window_duration', 8.192)
    % struct('signal_sel', "EHR_signal", 'window_duration', 8.192)
...
p.legend_vec = {
    ...
    % "IPFM-HB, 10s windows"
    % "IPFM-HB, 5s windows"
    "Raw PVP, 8.192s windows"
    "IPFM-PVP, 8.192s windows"
    "IPFM-HB, 8.192s windows"
    };
p.line_styles = {
    "-o"
    % "--o"
...
profile_name = "Pig, S/B - 8.192s Windows";
p = struct;
% p.primary_var = "frequency_limit";
p.primary_var = "alpha";
p.primary_vals = 0.5;
